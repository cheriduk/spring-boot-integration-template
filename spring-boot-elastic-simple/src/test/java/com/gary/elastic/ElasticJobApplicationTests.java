package com.gary.elastic;

import com.gary.elastic.model.FileCustom;
import com.gary.elastic.service.FileService;
...
@SpringBootTest(classes = ElasticJobApplication.class)
